                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('description', isset($country) ? $country->description : '', ['style'=>'resize:none','class'=>'form-control','placeholder'=>'Nhập dữ liệu','id'=>'title-danhmuc']) !!}
                        </div>
                        <div class="form-group">
                    ...
                    <tr>
                      ...
                      <td>
                        <div style="display: flex;">
                            ...
                            {!! Form::open(['method'=>'DELETE','route'=>['country.destroy',$cate->id], 'onsubmit'=>'return confirm("Bạn chắc chắn muốn xóa?")']) !!}
