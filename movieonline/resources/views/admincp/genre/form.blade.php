                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('description', isset($genre) ? $genre->description : '', ['style'=>'resize:none','class'=>'form-control','placeholder'=>'Nhập dữ liệu','id'=>'title-danhmuc']) !!}
                        </div>
                        <div class="form-group">
                    ...
                    <tr>
                      ...
                      <td>
                        <div style="display: flex;">
                            ...
                            {!! Form::open(['method'=>'DELETE','route'=>['genre.destroy',$cate->id], 'onsubmit'=>'return confirm("Bạn chắc chắn muốn xóa?")']) !!}
