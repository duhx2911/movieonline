...
<html lang="vi">
  <head>
    ...
    <link rel="shortcut icon" href="https://img.icons8.com/arcade/64/null/movie-projector.png" type="image/x-icon" />
    ...
    <style>
      #header .site-title {
        background: url(/imgs/motchill.png) no-repeat top left;
  ...
  <body class="home blog halimthemes halimmovies" data-masonry="">
      ...
      <div class="container">
        <nav class="navbar halim-navbar main-navigation" role="navigation" data-dropdown-hover="1">
          <div class="navbar-header">
            ...
            <button type="button" class="navbar-toggle collapsed pull-right get-bookmark-on-mobile"> Bookmarks <i class="fa-regular fa-bookmark" style="color: #ffffff;"></i>
              <span class="count">0</span>
            </button>
            ...
            <div class="menu-menu_1-container">
              <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                ...
                <li class="mega dropdown">
                  <a title="Thể Loại" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Thể Loại <span class="caret"></span>
                  </a>
                ...
                <li class="mega dropdown">
                  <a title="Quốc Gia" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Quốc Gia <span class="caret"></span>
                  </a>
                  <ul role="menu" class=" dropdown-menu">
                    @foreach ($country as $key => $coun)
                      <li>
                        <a title="{{$coun->title}}" href="{{route('country',$coun->slug)}}">{{$coun->title}}</a>
                      </li>
                    @endforeach
                  </ul>
                </li>
      ...
      <div class="container footer-columns">
        <div class="row container">
          <div class="widget about col-xs-12 col-sm-4 col-md-4">
            ...
            </div> Liên hệ QC: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">[email&#160;protected]</a>
          </div>
        </div>
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v16.0" nonce="pCIeALr0"></script>
    {{-- Tim kiem --}}
            ...
            $.getJSON('json/movies.json', function(data){
              $.each(data, function(key, value){
                if(value.title.search(expression) != -1){
                  $('#result').append('<li class = "list-group-item" style = "cursor: pointer; font-weight:bold;"><img style="width : 70px; margin-right: 20px;" src="/uploads/movie/'+value.image+'">'+value.title+'</li>');
                }
              });
            })
          }else{
